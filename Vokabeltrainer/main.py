...
ttk.Label(root, text="Pfad zur CSV-Datei angeben", background="#C3B1E1", foreground="#000000", font=('Arial', 10)).grid(column=0, row=1)
entryCSV = ttk.Entry(root)
...
def read_entryCSV():
    try:
        ...
        #     print(translation)
        ttk.Label(root, text="  Datei ausgelesen  ", background="#C3B1E1", foreground="#000000", font=('Arial', 10)).grid(column=0, row=3)
        ...
        ttk.Label(root, text="Datei nicht gefunden", background="#C3B1E1", foreground="#FF0000", font=('Arial', 10)).grid(column=0, row=3)
...
def equal():
    ...
    root.after(1500, clear_ergebnis)
    input.delete(0, END)
...
loesung = ttk.Label(root, text=akt, background="#C3B1E1", foreground="#000000", font=('Arial', 15))

entryCSV.grid(column=0, row=2)

buttonOK = ttk.Button(root, text="Datei auslesen", command=read_entryCSV)
buttonOK.grid(column=1, row=2, padx=5, pady=5)


buttonConfirm = ttk.Button(root, text="Abschicken", command=equal)
ergebnis = ttk.Label(root, text='', background="#C3B1E1", foreground="#000000", font=('Arial', 10))

input = ttk.Entry(root,font=('Arial', 15))
